...
function M.setup()
  ...
  -- vim.api.nvim_set_hl(0, 'Normal', { ctermfg = 248, ctermbg = 16, fg = '#a8a8a8', bg = '#000000' })
  vim.api.nvim_set_hl(0, "Normal", { ctermbg = 16, bg = "#000000" })
  ...
  vim.api.nvim_set_hl(0, "String", { ctermfg = 78, fg = "#5fd787" })
  ...
  vim.api.nvim_set_hl(0, "Constant", { ctermfg = 217, fg = "#ffafaf" })
